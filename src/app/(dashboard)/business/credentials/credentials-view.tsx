...
import type { BusinessCredential, Business, Profile } from '@/types/database';
...
interface CredentialsViewProps {
  ...
  business: Business;
  initialCredentials: BusinessCredential[];
}
...
export function CredentialsView({
  ...
  const [credentials, setCredentials] = useState<BusinessCredential[]>(initialCredentials);
  ...
  async function handleAddCredential() {
    ...
    const result = await addCredential({
      ...
      credential_number: newCredential.credential_number,
    ...
    // Refresh the page to get updated credentials
    router.refresh();
  }
