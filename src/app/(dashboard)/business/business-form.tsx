...
interface BusinessFormProps {
  ...
  categories: Category[];
  initialBusinessCategories: string[];
}

export function BusinessForm({ initialBusiness, categories, initialBusinessCategories }: BusinessFormProps) {
