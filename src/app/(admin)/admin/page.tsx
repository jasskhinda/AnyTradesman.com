          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Link href="/admin/users" className="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center gap-1">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Link href="/admin/businesses" className="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center gap-1">
                  View all <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </CardHeader>
